...
void FitPVResiduals_forLoop(TString namesandlabels,bool stdres=true,bool do2DMaps=false,TString theDate="bogus");
...
//*************************************************************
void FitPVResiduals_forLoop(TString namesandlabels,bool stdres,bool do2DMaps,TString theDate){
//*************************************************************
