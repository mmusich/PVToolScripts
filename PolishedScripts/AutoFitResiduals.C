...
void arrangeCanvas(TCanvas *canv,TH1F* meanplots[100],TH1F* widthplots[100],Int_t nFiles,TString LegLabels[10]);
...
void AutoFitResiduals(TString namesandlabels);
...
//*************************************************************
  ...
  Int_t colors[8]={0,1,2,3,4,1,2,3};
  setStyle();
  ...
  for(Int_t j=0; j < nFiles_; j++) {
    ...
    cout<<"AutoFitResiduals::AutoFitResiduals(): label["<<j<<"]"<<LegLabels[j]<<endl;
...
//*************************************************************
  ...
  pt->SetTextFont(42);
  pt->SetTextAlign(11);
  TText *text1 = pt->AddText("CMS preliminary 2014    p-p data, #sqrt{s}=2.76 TeV");
...
{ 
  ...
  Int_t colors[4]  = {kBlack,kRed,kBlue,kMagenta};
